...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def learn(
        ...
        print("finishing at timestep ", self.num_timesteps, total_timesteps)
    ...
    def collect_rollouts(
        ...
        while should_collect_more_steps(train_freq, num_collected_steps, num_collected_episodes):
            ...
            while not done:
                ...
                step_times += (step_time_end-step_time_start)
                #print("action", action)


                # add intrinsic motivation
                #intr_reward =  self.intr_reward(new_obs)
                #reward = (reward/self.best_reward + intr_reward)
                ...
                if callback.on_step() is False:
                    ...
                    return RolloutReturn(0.0, num_collected_steps, num_collected_episodes,
                                         step_times, continue_training=False)
        ...
        return RolloutReturn(mean_reward, num_collected_steps, num_collected_episodes, continue_training, step_times)
